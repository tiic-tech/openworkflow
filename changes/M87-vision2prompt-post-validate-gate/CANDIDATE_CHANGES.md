...
| --- | --- | --- | --- | --- |
| C001 | ready | medium | Define prompt asset post-validate contract | none |
| C002 | candidate | medium | Implement deterministic strategic fingerprint evaluator | C001 |
...
`C001` should go first. It defines the artifact contract and skip/pass/fail
semantics before algorithm or generated protocol work.
